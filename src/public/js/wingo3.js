function showHistoryCoins(array, type = 'new') {
   const container = $('.history_images'); 

   const urls = [
       "/assets/png/n0-30bd92d1.png", "/assets/png/n1-dfccbff5.png", "/assets/png/n2-c2913607.png",
       "/assets/png/n3-f92c313f.png", "/assets/png/n4-cb84933b.png", "/assets/png/n5-49d0e9c5.png",
       "/assets/png/n6-a56e0b9a.png", "/assets/png/n7-5961a17f.png", "/assets/png/n8-d4d951a4.png",
       "/assets/png/n9-a20f6f42.png"
   ];
   ...
   if (type === 'new') {
       ...
       const img = document.createElement('img');
       img.src = urls[array[0]];
       img.alt = `coin${array[0]}`;
       img.style.width = '25px';
       img.style.margin = '2px';

       const lastImg = container.children().last(); 
...
socket.on("data-server", function (msg) {
   ...
   setTimeout(() => {
      ...
      const lastFive = data2.slice(0,5).map(item=>item.amount);
      showHistoryCoins(lastFive,'push');
      pageno = 0
      limit = 10
      page = 1
      ...
      $.ajax({
         ...
         success: function (response) {
            ...
            if (firstGame && String(firstGame.stage) === String(result.period)) {
               if (firstGame.get == 0) {
...
$(".game-list .tab .li:eq(0)").click(function (e) {
   ...
   $.ajax({
      ...
      success: function (response) {
         ...
         const lastFive = list_orders.slice(0,5).map(item=>item.amount);
         showHistoryCoins(lastFive);
...
function showListOrder2(list_orders, x) {
   ...
   let result = list_orders.map(list_orders => {
      ...
      return (htmls += `
                      <div data-v-a9660e98="" issuenumber="${list_orders.stage}" addtime="${timerJoin(list_orders.time)}" colour="red" number="6" rowid="${i}" class="hb">
                              ...
                              <div data-v-a9660e98="" class="c-row c-row-between info">
                                  <div data-v-a9660e98="">
                                      <div data-v-a9660e98="" class="issueName">
                                          ${list_orders.stage} 
                                          ${list_orders.status == 1 ? '<span data-v-a9660e98="" class="state green">Success</span>' : list_orders.status == 2 ? '<span data-v-a9660e98="" class="state red">Fail</span>' : ""}
                                      </div>
                                      <div data-v-a9660e98="" class="tiem">${timerJoin(list_orders.time)}</div>
                                  </div>
                                  <div data-v-a9660e98="" class="money">
                                  ${
                                     list_orders.status == 1 && list_orders.bet == 0
                                        ? '<span data-v-a9660e98="" class="success"> + ' + list_orders.money * 4.5 + " </span>"
                                        : list_orders.status == 1 && list_orders.bet == 5
                                        ? '<span data-v-a9660e98="" class="success"> + ' + list_orders.money * 4.5 + " </span>"
                                        : list_orders.status == 1 && list_orders.result == 0 && list_orders.bet == "d"
                                        ? '<span data-v-a9660e98="" class="success"> + ' + list_orders.money * 1.5 + " </span>"
                                        : list_orders.status == 1 && list_orders.bet == "d"
                                        ? '<span data-v-a9660e98="" class="success"> + ' + list_orders.money * 2 + " </span>"
                                        ...
                                        ? '<span data-v-a9660e98="" class="success"> + ' + list_orders.money * 9 + " </span>"
                                        : list_orders.status == 2
                                        ? '<span data-v-a9660e98="" class="fail"> - ' + list_orders.money + "</span>"
                                        : ""
                                  }
                                  </div>
                              </div>
                          ...
                          <div data-v-a9660e98="" class="details" style="display: none">
                              ...
                              <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                  ...
                                  <div data-v-a9660e98="" data-clipboard-text="${list_orders.id_product}" class="tag-read c-row c-row-between c-row-middle">
                                      ${list_orders.id_product}
                                      <img data-v-a9660e98="" width="18px" height="15px" src="/images/copy.png" class="m-l-5">
                                  </div>
                                  </div>
                                  <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                      <div data-v-a9660e98="">Draw Period</div>
                                          <div data-v-a9660e98="">${list_orders.stage}</div>
                                      </div>
                                      <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                          <div data-v-a9660e98="">Purchase Amount</div>
                                          <div data-v-a9660e98="">${list_orders.money + list_orders.fee}.00</div>
                                      </div>
                                      <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                          <div data-v-a9660e98="">Quantity Purchased</div>
                                      ...
                                      <div data-v-a9660e98="">
                                          <div data-v-a9660e98="" style="display: inline-block; margin-left: 8px;">${list_orders.result}</div>
                                          <div data-v-a9660e98="" style="display: inline-block; margin-left: 8px;">${list_orders.result == 0 ? "Red Violet" : list_orders.result == 5 ? "Green Violet" : list_orders.result % 2 == 0 ? "Red" : "Green"}</div>
                                          <div data-v-a9660e98="" style="display: inline-block; margin-left: 8px;">${list_orders.amount < 5 ? "Small" : "Big"}</div>
                                      </div>
                                  </div>
                                  <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle ">
                                  ...
                                  <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                      ...
                                      <div data-v-a9660e98="" class="${list_orders.status == 1 ? "green" : list_orders.status == 2 ? "red" : ""}">${list_orders.status == 1 ? "Success" : list_orders.status == 2 ? "Fail" : ""}</div>
                                  </div>
                                  <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                      <div data-v-a9660e98="">Win Or Loss</div>
                                      <div data-v-a9660e98="" class="${list_orders.status == 1 ? "green" : list_orders.status == 2 ? "red" : ""}"> ${list_orders.status == 1 ? "+" : list_orders.status == 2 ? "-" : ""} ${
