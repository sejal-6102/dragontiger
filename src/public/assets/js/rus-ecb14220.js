const e = {
   ...
   tip6digitVeriCode: "Please enter the 6-digit verification code",
   ...
   promotionRuleDesc4: "Depending on the amount of the refund, the rate of refund is different.",
   ...
   vipGrade: "Level",
   teamMembers: "Amount of people",
   teamStream: "Total bet",
   teamRecharge: "Total team deposit",
   friendsGrade: "Level",
   ...
   code316: "The balance recovery request time is 30 seconds. Please try again later",
   ...
   titleGot: "Receive",
   dailyRateReturn: "Daily interest rate {0}%, calculated once every {1} minute",
   prompt: "Notification",
   ...
   orderAmount: "Amount",
   amountActuallyPaid: "Actual payment amount",
   ...
   oncebetgenerated: "Once a bet is confirmed (successful bet), it cannot be canceled or changed.",
   ...
   fairAndSafe: "Cash Quickly-Safety-Stablize",
   ...
   RebateDetailTip2: "[Washing Rate] Rebate Details",
   ...
   turnedOn: "Turned on",
   unopened: "Unopened",
   eachrechageAmount: "Each person's recharge amount",
   registernum: "Number of registers",
   requiredFaild: "Required fields",
   delAllBtn: "Delete all records",
   delAllTip1: "Whether to delete all records",
   delAllTip2: "After deleting the data cannot be recovered, please do it carefully",
   enterTRXAmount: "Please enter TRX amount",
   selectTRXNum: "Select amount of TRX",
   ...
   xosoTxt33: "The top 2 of the award of the lottery results is 45, and it is the winning.",
   ...
   xosoTxt74: "Cancel number number",
   xosoTxt75: "Revoked",
   ...
   code9431: "Ten positions",
   code9432: "Individual",
   code9440: "Samsung",
   code9442: "One prize",
   code9443: "Six prizes",
   code9444: "Six/Special Awards",
   code9446: "Seven special prizes",
   code9450: "Four -star",
   code9460: "Different number",
   code9461: "Four yards",
   code9462: "Eight yards",
   code9463: "Ten yards",
   code9470: "Fun game",
   code9471: "Single and double",
   code9472: "Harmony",
   code9480: "North",
   code9481: "Central",
   code9482: "Southern part",
   code9900: "Hanoi",
   code9901: "Guangning",
   code9902: "North",
   code9904: "Sea defense",
   code9905: "South",
   code9906: "Peace",
   code9907: "Cosmetic",
   code9908: "Wealth",
   ...
   code9916: "Jialai",
   code9917: "Unbounded",
   code9919: "General sense",
   code9920: "Farm",
   code9922: "Kunsong",
   code9924: "Ho Chi Minh City",
   code9925: "Tower",
   code9926: "Golden",
   code9927: "Chain",
   code9928: "Head",
   ...
   code9475: "one",
   code9476: "pair",
   kbzName: "KPay mobile phone number",
   kbzMobile: "KPay name",
   ...
   rechargePerPerson: "recharge per person",
   recycling: "recycling",
   c2cvalidity: "validity",
   winOdds: "Win",
   activeObject: "активный объект",
   totalValidBets: "общее количество действительных ставок",
   Bonus: "Бонус",
}
export { e as r }
