const e = {
   ...
   tipDoNotEnterUnvalideNickname: "Please do not enter a Nickname with more than 12 characters",
   feedback: "Feedback",
   ...
   tipMinimumIncome: "Minimum return, daily interest",
   ...
   tipTransferAnytimeGuarantedUnderSolidIncomes: "Provided your income is guaranteed, you can transfer out at any time, from the balance of the safe to the balance of the wallet and the amount transferred must be a multiple of the number of copies",
   ...
   phEnterVerificationCode: "Please enter the confirmation code",
   ...
   settlementIncome: "Payout income",
   fundSafety: "Financial security",
   descTotalAssets: "Transfer in 1 million, income 1000 per day",
   ...
   instructionDes: 'Need to bet <span data-v-470caa86 class="red">{0}</span> to be able to withdraw',
   ...
   fishing: "Fishing",
   miniGame: "Original",
   feedbackPhTXT: "Welcome to feedback, please give feedback-please describe the problem in detail when providing feedback, preferably attach a screenshot of the problem you encountered, we will immediately process your feedback!",
   ...
   pointsMallTxt: "Mall",
   selectUSDTNum: "Select amount of USDT",
   ...
   withdrawDialogPh: "Please enter your login password",
   ...
   enterUSDTAmount: "Please enter UDST amount",
   ...
   fullOddsReturnRate: "Full Odds <span>Bonus</span> Rate",
   financialSecurity: "Financial security",
   withdrawFast: "Quick withdrawal",
   highestRebate: "Permanent commission<span>up to</span>{0}%",
   ...
   titleGot: "Receive",
   dailyRateReturn: "Daily interest rate {0}%  + VIP extra income safe, calculated every {1} minute",
   prompt: "Notification",
   ...
   idlockTip2: "Please Use Forgot Password To Change New Password For Unlock And Log In",
   ...
   experience1: "Bet {0}{1}=1EXP",
   upgrade: "{0} EXP can be leveled up",
   achieved: "Achieved",
   vipTip1: 'Dear <h3 class="level{0}">VIP{1}</h3> customer',
   ...
   vipTip6: "VIP level upgraded to [VIP{0}]",
   vipTip7: "Betting EXP",
   vipTip8: "VIP level",
   ...
   xosoTxt2: "If the number you cast matches the last {1} digits of any group of numbers in the {0} positions of the lottery result, you will win. If there is more than 1 winning number, the winning amount will be doubled accordingly.",
   ...
   enterUsdtAddress: "Please enter your transaction/hash id",
   upiInstructions1: "After completing the UPI transaction, please fill in Ref NO./utr If you do not fill in UTR,the loss of customer , our company will not responsible. please be sure to fill it back！",
   upiInstructions2: "If you are wrong when you create an order, the loss of customer , our company will not responsible !",
   ...
   transferAddress: "Transaction/hash id",
   ...
   tipemaildigitVeriCode: "Please enter the 6-digit verification code of email address {0}",
   ...
   winGoRule: "Through the platform WIN GO Hash lottery seed as the result of the lottery",
   ...
   d5Rule: "5 numbers are used as the result of the lottery, and the playing methods are flexible and diverse",
   makeBet: "make a bet",
   ...
   damanRule: "The Daman platform advocates fairness, justice, and openness. We mainly operate fair lottery, blockchain games, live casinos, and slot machine games.",
   damanRule2: "Daman works with more than 10'000 online live game dealers and slot games, all of which are verified fair games.",
   damanRule3: "Daman supports fast deposit and withdrawal, and looks forward to your visit.",
   damanWarn: "Gambling can be addictive, please play rationally.",
   damanWarn2: "Daman only accepts customers above the age of 18.",
   ...
   plsEnterCorrectEmail: "please enter your vaild email!",
   ...
   firstSave4: "The bonus (excluding the principal) given in this event requires 1.00 times the coding turnover (i.e. valid bets) before it can be withdrawn, and the coding does not limit the platform;",
   ...
   laundryTxt2: "Automatic code washing at 01:00:00 every morning",
   FXOSO: "XOSO Speed ​",
   whiteColor: "White",
   orangeColor: "Orange",
   ...
   code8116: "New members will receive bonuses if they make a loss on their first deposit",
   withdrwsTip5: "Please confirm your beneficial account information before withdrawing. If your information is incorrect, our company will not be liable for the amount of loss",
   withdrwsTip6: "If your beneficial information is incorrect, please contact customer service",
   code8117: "New members get bonuses by playing games",
   newVersionFounded: "new version found",
   forBetterServices: "In order to give you the best service experience",
   upgradeToLateastVersion: "Please download the latest version of APP",
   deleteOldApp: "If two APPs appear after updating, please delete the old APP.",
   upgradeNow: "update immediately",
   oldPromptTip: "Old man, you are finally back",
   oldPrompt: "I miss you so much",
   oldPromptGift: "I prepared a gift for you",
   activityIntroduce: "Event Description",
   activityTurntable: "turntable",
   eventDetails: "Event Details",
   activeObject: "active object",
   totalValidBets: "Total valid bets",
   Bonus: "bonus",
   activityTime: "Event start time",
   newMenberPackage: "New member gift package",
   newMenberTip: "There are two types of new member gift package rewards:",
   newMenberRule: "Bonus bonus for first deposit negative profit",
   newMenberRule2: "Play games and get bonuses only for new members",
   conditionsRule: "Conditions of participation",
   afterDayBonus: "Get bonus the next day",
   todayBonus: "Total negative profit rebate for the day",
   bonusLimit: "Bonus limit",
   receiveTips: "The membership system that meets the standard automatically distributes bonuses",
   grandTotalDeposit: "Accumulated deposits",
   totalValidBet: "Valid bet",
   giftBonus: "Bonus bonus",
   activityApply: "Apply",
   witeApply: "Pending application",
   applySuccess: "Application successful",
   newMemberDeposit: "First deposit for new users",
   registrationFull: "Membership gift package after registration for {0} days",
   registrationFullTip: "Membership bonuses after registering for {0} days are as follows:",
   newMemberPlayGame: "New members get bonuses by playing games",
   newMemberDepositTime: "Negative hourly profit",
   platformBonus: 'The platform returns <span class="number">{0}%</span> bonus',
   registrationDepositTip: "Registered for {0} days and accumulated deposits {1}+",
   registrationExample: 'New member registration<span class="number">{0}</span> days, accumulated deposits<span class="number">{1}+</span>, valid bets<span class="number">{2}+</span>, you can apply for <span class="number">{3}</span> bonus.',
   depositMoney: "deposits",
   turntableCount: "Number of spins",
   winType: "Reward type",
   turntableWin: "prize",
   turntableTime: "spin time",
   turntableWinTip: "Congratulations on your draw",
   amountReward: "Amount reward",
   physicalReward: "physical rewards",
   introduceContent: "If a member applies repeatedly, the company reserves the right to cancel or withdraw member bonuses.",
   introduceTitle: "The event is effective from now on. The discount can only be used once per address, per email address, per phone number and for the same payment method (debit/credit card/bank account) and IP address;",
   introduceContent2: "If any group or individual is found to be dishonestly withdrawing bonuses or threatening or abusing company offers, the company reserves the right to freeze or cancel the account and account balance of that group or individual.",
   introduceTitle2: "All offers are specially designed for players.",
   introduceContent3: "and the right to modify or terminate the campaign without prior notice; these terms apply to all offers.",
   introduceTitle3: "The platform reserves the right of final interpretation of this event;",
   turntableActivityTime: "Activity time",
   turntableStart: "From now on",
   validityPeriod: "Validity period",
   officialNotice: "Official website notification shall prevail",
   turntableRule: "Members whose single deposit amount or accumulated deposit amount reaches the set amount can participate in the lottery.",
   turntableJoinRule: "Conditions of participation",
   turntableSatisfy: "Members who meet the requirements of <span>{0}</span> can participate in the carousel event. Need to bind a bank card. Hundreds of millions of cash and many other prizes are up for grabs. Get ready for endless surprises and grand prizes every day!",
   turntableBind: "Need to bind",
   turntablePrize: "With hundreds of millions in cash and many other prizes up for grabs, get ready for endless surprises and big prizes every day!",
   turntableTask: "Task",
   singleDeposit: "single deposit",
   cumulativeDeposits: "Cumulative deposits",
   turntableRule2: "Members must reach the single deposit amount and cumulative deposit amount to be eligible to participate in the lottery",
   turntableRule3: "Conditions for withdrawal of wheel rewards: <span>1</span> times turnover required.",
   turntableRule4: "If you receive monetary rewards, there is no need to apply, the system will automatically add them to your member ID (please contact customer service to receive physical rewards)",
   turntableRule5: "The lottery round starts every morning at <span>00:00</span>. After making your deposit, you need to wait 5 minutes before the draw wheel starts.",
   turntableExample: "If a member's single deposit exceeds <span>{0}</span> on the same day, he or she will receive <span>{1}</span> lucky draw opportunities. The lottery draws are valid for the same day and cannot be accumulated to the next day!",
   rebateRatio: "Rebate ratio",
   rebateLevel: "Rebate level",
   lowerRrebate: "{0} level lower level commission rebate",
   settlementState: "Settlement successful",
   tTommission: "The commission has been automatically credited to your balance",
   date: "date",
   totalBetP: "Total number of bettors",
   totalBetA: "Total bet amount",
   totalCommissionA: "Total commission settlement",
   rebateRules: "Rebate level rules",
   lowerLevel: "lower level",
   lookRerbate: "View rebate ratio >>",
   commissionChess: "Chess and card rebates",
   commissionSport: "Sports rebate",
   commissionGames: "Mini game rebate",
   code8119: "Turntable Awards",
   code8121: "Deposit Bonus",
   code901: "Turntable events are not open yet",
   code902: "Your vip level cannot be used for draws",
   code903: "Your account cannot draw prizes",
   code904: "You can draw prizes after binding your bank card",
   code905: "Your draws have been exhausted",
   code906: "Turntable activity data is under maintenance",
   code191: "IFSC format is incorrect",
   code41: "Server is busy, please try again later",
   code246: "The number of red packets received today has reached the upper limit",
   transferType: "Transfer type",
   banktobank: "bank to bank",
   wallettobank: "wallet to bank",
   rechargeBankVailte2: "Please enter the name and account number that are consistent with the transfer account number",
   turntableTip: "You can participate in the big carousel after binding {0}",
   signed: "Signed in",
   rechargeToday: "Recharge today",
   signeRequest: "Sign-in requirements",
   code1001: "Order status is incorrect",
   code192: "Insufficient registration days to apply for new member rewards",
   selectRechargeAmount: "Select recharge amount",
   confirmRecharge: "Confirm recharge",
   rechargeCount: "Recharge quantity",
   walletAddress: "wallet address",
   comminWallet: "Enter wallet",
   arNoActive: "Your AR wallet has not been activated yet",
   arNoActive2: "Wallet is not activated",
   arWallet: "AR wallet",
   arNumber: "ARB quantity",
   arActive: "Activate AR wallet",
   arTip: "ARB is an officially issued encrypted digital currency, referred to as ARB. It is recommended to use ARB for recharge.",
   arGift: "Use ARPAY to recharge for additional rewards {0} bonus",
   loading: "loading",
   maxAmount: "maximum amount",
   maxAmount2: "Maximum withdrawal amount",
   minAmount: "Minimum withdrawal amount",
   accountBlance: "Account Balance",
   arbTip2: "AR wallet can use ARB for quick deposits and withdrawals! ARB is a digital cryptocurrency jointly issued by the government, referred to as ARB. It is safe, stable and fast.",
   successWithdraw: "Withdrawn successfully to AR wallet",
   goArWallet: "Go to AR wallet",
   arWithdraw: "You need to place a bet {0} before you can withdraw money.",
   amountError: "Insufficient amount",
   enterA: "Enter the withdrawal amount",
   arWTip1: "Use {0} to withdraw money and receive a bonus for each withdrawal;",
   arWTip2: "Use {0} to withdraw cash and support UPI for quick payment;",
   withdrawAppeal: "Withdrawal is under review",
   withdrawAr1: "Withdrawal has been applied for and after approval",
   withdrawAr2: "The balance will be withdrawn to AR wallet",
   withdrawTip5: "Supports UPI for fast payment, and bonuses for withdrawals",
   haveArpayOrder: "Already have a recharge order",
   haveArpayOrderTip: "You already have an uncompleted recharge order, please complete it first",
   arb1: "Insufficient ARB balance, would you like to proceed to purchase ARB?",
   arb2: "After purchasing ARB, please return for recharge.",
   arb3: "Receive an additional {0}% bonus when recharging with ARB.",
   arb4: "Go to Purchase",
}
export { e }
